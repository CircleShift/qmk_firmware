 ...
 * Copyright 2025 CircleShift Hardware <interactive@cshift.net>
...
enum layers {
    ...
    MACOS_BL, // MacOS Base Layer
    MACOS_FL  // MacOS Function Layer
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MACOS_FL] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,                                      _______,  _______,  _______,
        _______,            RM_SATD,  RM_SATU,  RM_SPDD,  RM_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,            _______,               RM_VALU,               _______,  _______,  _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,     RM_PREV, RM_VALD,  RM_NEXT,     _______,            _______
    ),
};
// clang-format on
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [WIN_FL] = { ENCODER_CCW_CW(RM_VALD, RM_VALU) },
    [MACOS_BL] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [MACOS_FL] = { ENCODER_CCW_CW(RM_VALD, RM_VALU) }
};
#endif
